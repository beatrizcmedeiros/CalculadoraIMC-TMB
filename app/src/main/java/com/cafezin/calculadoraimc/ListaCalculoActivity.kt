...
import com.cafezin.calculadoraimc.databinding.ActivityListaCalculoBinding
...
class ListaCalculoActivity : AppCompatActivity(), OnListClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tipo =
            intent?.extras?.getString("tipo") ?: throw IllegalStateException("Tipo não encontrado!")
    ...
    private inner class ListaCalculoAdapter(
        ...
        private inner class ListaCalculoViewHolder(itemView: View) :
    ...
    override fun onLongClick(position: Int, calculo: Calculo) {
        AlertDialog.Builder(this)
            .setMessage("Você que mesmo apagar esse texto?")
